...
const Services = () => {
  return (
    <div className='services'>
      ...
      <p>
        Hello, My name is Jonathan Roth and I'm an aspiring web developer.<p>After
        ...
        began to teach myself HTML, CSS, and Javascript in 2017.</p> 
        <p>In the summer
        of 2019, I was given the opportunity to attend a full stack web
        development bootcamp at the University of Richmond in Virginia.</p> 
        <p>The
        ...
        library.</p> 
        <p>I am excited to learn new technologies and to set and achieve
        goals. I am delighted you have stopped by to view my portfolio and would
        love to talk about joining your team!</p>
      </p>
    </div>
  );
};
